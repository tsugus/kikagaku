...
\begin{thm}[シュワルツ(Schwarz)の不等式]\label{251101135202}
  \(|(\vec{a},\vec{b})|\leqq\|\vec{a}\|\|\vec{b}\|.\)
\end{thm}

\begin{proof}
  \(\vec{a}=\vec{0}\) ならば、定理 \ref{251101135001} より明らかに成り立つ。

  ゆえに \(\vec{a}\neq\vec{0}\) とする。
  公理 \ref{251101141801} より、任意の実数 \(\lambda\) に対して
  \[(\lambda\vec{a}+\vec{b},\lambda\vec{a}+\vec{b})\geqq0.\]
  公理 \ref{251101141801} を用いて左辺を展開すると、
  \[(\vec{a},\vec{a})\lambda^2+2(\vec{a},\vec{b})\lambda+(\vec{b},\vec{b})\geqq0.\]
  \(\vec{a}\neq\vec{0}\) より \((\vec{a},\vec{a})>0\) であるから、左辺を平方完成すると
  ...
  ゆえに、左辺は \(\displaystyle\lambda=-\frac{(\vec{a},\vec{b})}{(\vec{a},\vec{a})}\) のとき最小値をとり、それが \(\geqq0\) でなければならない。
  よって
...
\begin{proof}
  \begin{enumerate}
    ...
    ゆえに、\(x=(\vec{a},\vec{a})\) とおけば、ノルムの定義と公理 \ref{251101141801} より明らか。
    \item
      \begin{align*}
      ...
      \end{align*}
      最後の不等号は定理 \ref{251101135202} による。
    \item
      \begin{align*}
...
\begin{proof}
  垂直の定義と公理 \ref{251101141801} より明らか。
\end{proof}
...
\begin{proof}
  定理 \ref{251101135001} の系より明らか。
\end{proof}

\begin{thm}
  \(\vec{a}\perp\vec{b}\) ならば \(\vec{a}/\!/\vec{b}\) でない。
\end{thm}

\begin{proof}
  対偶を証明する。
  \(\vec{a}=\lambda\vec{b}\) \((\vec{b}\neq\vec{0})\) と表されたとする。
  \(\vec{a}\neq\vec{0}\) より \(\lambda\neq0.\)
  ゆえに
  \[(\vec{a},\vec{b})=(\lambda\vec{b},\vec{b})=\lambda(\vec{b},\vec{b})\neq0.\]
\end{proof}

\begin{thm}\label{251101144501}
...
\begin{proof}
  \begin{align*}
    \left(\vec{a},\vec{b}-\frac{(\vec{a},\vec{b})}{\|\vec{a}\|^2}\vec{a}\right) &= (\vec{a},\vec{b})+\left(\vec{a},-\frac{(\vec{a},\vec{b})}{\|\vec{a}\|^2}\vec{a}\right) \\
                                                                                &= (\vec{a},\vec{b})-\frac{(\vec{a},\vec{b})}{\|\vec{a}\|^2}\cdot(\vec{a},\vec{a}) \\
                                                                                &= (\vec{a},\vec{b})-\frac{(\vec{a},\vec{b})}{\|\vec{a}\|^2}\cdot\|\vec{a}\|^2=0.
  \end{align*}
\end{proof}
...
\begin{col*}
  定理 \ref{251101141501} の系における、その表され方はただ一つである。
\end{col*}
